<template>
  ...
  <div class="w-100">
    ...
    <q-tabs clickable
      @click="loadUrl('https://www.topachat.com/pages/produits_cat_est_micro_puis_rubrique_est_w_cm_am4.html')"
      indicator-color="yellow" class="bg-blue-5 text-white shadow-2">
      <q-item class="title-item">Carte mère AM4</q-item>
    ...
    <q-item class="flex-center q-pt-md q-pb-md bg-white">
      <q-btn glossy color="blue-5"
        href="https://www.topachat.com/pages/produits_cat_est_micro_puis_rubrique_est_w_cm_am4.html" class="w-100">
        Voir plus de
        produits</q-btn>
    </q-item>
